...
class Game {
    constructor() {
        ...
        this.balls = [
            new Ball(canvas.width / 2, canvas.height / 2, 10, 4, 4, 'orange'),   // Pelota principal
            new Ball(canvas.width / 2, canvas.height / 2, 15, 2, 3, 'blue'),   // Pelota más grande y más lenta
            new Ball(canvas.width / 2, canvas.height / 2, 8, 5, 2, 'green'),   // Pelota más pequeña y rápida
            new Ball(canvas.width / 2, canvas.height / 2, 12, 3, 5, 'yellow'), // Pelota de tamaño medio y velocidad media
            new Ball(canvas.width / 2, canvas.height / 2, 6, 6, 3, 'white')  // Pelota pequeña y muy rápida
        ];
